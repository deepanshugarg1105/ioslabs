...
//:  Create a `let` constant called `falcon` and assign it to an instance of `Spaceship`. After initialization, set `name` to "Falcon."
 let falcon = Speaceship()

falcon.name = "Falcon"

print("The name of the spaceship is: \(falcon.name)")
print("The current position of the spaceship is: \(falcon.position)")
...
falcon.moveLeft()
print("Position after moving left: \(falcon.position)")

falcon.moveLeft()
print("Position after moving left again: \(falcon.position)")

falcon.moveRight()
print("Position after moving right: \(falcon.position)")
